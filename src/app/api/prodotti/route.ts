...
export async function GET() {
  ...
  const forbidden = await requireAdminApi("Solo un amministratore può leggere il catalogo prodotti.");
...
export async function POST(req: Request) {
  ...
  const forbidden = await requireAdminApi("Solo un amministratore può gestire il catalogo prodotti.");
  if (forbidden) return forbidden;
